...
console.log('Tutorial check passed: critical-path planning, stable inspection, 2P scoped swap, 4P fixed ownership, live actions, optional cover observation, and completion.');
